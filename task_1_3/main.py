...
def main():
    ...
    match number:
        case "1":
            ...
            f = open('/home/dm_f101_round_f.csv', "w+")
            f.close()
        ...
        case "2":
            ...
            sql_query('''CREATE TABLE IF NOT EXISTS dm.dm_f101_round_f_v2 AS (SELECT * FROM dm.dm_f101_round_f) with no data;''')
            sql_query('''insert into LOGS.log_table (log_data, log_time) values ('Начало вставки в таблицу dm_f101_round_f_v2',  LOCALTIMESTAMP(0));''')
            ...
            sql_query('''insert into LOGS.log_table (log_data, log_time) values ('Окончена вставка в таблицу dm_f101_round_f_v2',  LOCALTIMESTAMP(0));''')
